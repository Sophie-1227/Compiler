...
class Translator:
    ...
    def translate(self, block, procedure_name, var_names):
        ...
        for command in block:
            if command[0] == "proc":
                ...
                self.code.append("STORE " + str(col1.index("good"+str(j-1))+len(global_.list_of_variables)))
                ...
                self.code.append("STORE " + str(col1.index("good"+str(j-1))+len(global_.list_of_variables)))
                col1 = [val[0] for val in global_.procedureStart]
                self.code.append("JUMPI "+str(col1.index(str("bad")+str(j-1))+len(global_.list_of_variables)))
    ...
    def evaluate(self, condition, procedure_name):
        ...
        if condition[0] == "eq":
            col1 = [val[0] for val in global_.procedureStart]
            self.code.append("LOAD " + str(col1.index(str("good")+str(j-1))+len(global_.list_of_variables)))
